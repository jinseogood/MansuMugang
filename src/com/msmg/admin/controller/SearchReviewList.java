...
@WebServlet("/searchReviewList")
public class SearchReviewList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SearchReviewList() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new ReviewService().getSearchListCount(type, content);
