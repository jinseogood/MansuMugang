...
public class QnA implements java.io.Serializable{
	...
	public QnA(){}
	public QnA(int board_id, int board_no, String board_sort, String title, String content, Date board_date,
			String u_name, int buy_info_no, int b_count, int ref_bno, String write_yn, int ref_ucode) {
		super();
