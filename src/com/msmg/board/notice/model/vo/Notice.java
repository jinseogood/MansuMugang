...
public class Notice {
	...
	public Notice(int board_id, int board_no, String board_sort, String title, String content, Date board_date, String u_name,
			int buy_info_no, int b_count, int ref_bno, String write_yn) {
		super();
	...
	public String toString() {
		return "Notice [board_no=" + board_no + ", board_sort=" + board_sort + ", title=" + title + ", content="
				+ content + ", board_date=" + board_date + ", u_name=" + u_name + ", buy_info_no=" + buy_info_no
				+ ", b_count=" + b_count + ", ref_bno=" + ref_bno + ", write_yn=" + write_yn + "]";
	}
