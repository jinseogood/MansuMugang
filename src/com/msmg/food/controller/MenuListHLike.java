...
/**
 * Servlet implementation class MenuListHLike
 */
@WebServlet("/MenuListHLike.fo")
public class MenuListHLike extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public MenuListHLike() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MenuList = new FoodService().menuListHLike(u_code);
		String page = "";
		if(MenuList != null){
			...
			page = "/views/menu/menuLikeIntro3.jsp";
